...
async function generateVideo(text, language = 'en', style = 'style_1', options = {}) {
  try {
    ...
    // Get the last video and calculate needed duration
    ...
    const targetDuration = lastTranscription.end + 5; // Add 5 seconds buffer

    // Loop last video until we reach target duration
